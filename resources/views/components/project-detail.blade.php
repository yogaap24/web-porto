<div id="project-detail-container" class="d-none">
    <div id="project-detail">
        <div class="pos__relative">
            <!-- Header Detail -->
            <div class="d-flex justify-content-between header-detail">
                <button onclick="backToProjects()" class="none-button" type="button">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                            stroke="#8F9BB3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path
                ...
                <a href="javascript:backToProjects()">Back To Projects</a>
            </div>
            ...
            <div class="main__post">
                ...
                <p>
                    <a href="https://chrome.google.com/webstore/detail/piggment-crafted-to-inspi/eifkhhlfjplpakoddkndkgjhfajnhffg"
                        target="_blank" rel="noopener noreferrer"
                        id="detail-website">https://chrome.google.com/webstore/detail/piggment-crafted-to-inspi/eifkhhlfjplpakoddkndkgjhfajnhffg</a>
                </p>
                ...
                <div id="container-github">
                    ...
                    <p>
                        <a href="https://github.com/adenekan41/piggment-chrome" target="_blank"
                            rel="noopener noreferrer"
                            id="detail-github">https://github.com/adenekan41/piggment-chrome</a>
                    </p>
                </div>
